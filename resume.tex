...
%── Header ────────────────────────────────────────────────────
\begin{center}
  {\LARGE\bfseries Sai Kumar Agiri}\\[4pt]
  {\color{mutedtext}\small
    \faIcon{map-marker-alt}~Hyderabad, India \quad
    \faIcon{github}~\href{https://github.com/4-sai}{github.com/4-sai} \quad
    \faIcon{linkedin}~\href{https://linkedin.com/in/4-sai}{linkedin.com/in/4-sai}
  }
\end{center}
...
\textbf{Release Engineer} \hfill \textit {PubMatic} \hfill \textcolor{mutedtext}{Oct 2025 -- Present}
\begin{itemize}
  ...
  \item Built observability stack (Prometheus + Grafana + Loki)
  \item Deployed and managed containerized applications using Docker, Kubernetes, and Helm
\end{itemize}

\vspace{4pt}

\textbf{Systems Engineer} \hfill \textit{PubMatic} \hfill \textcolor{mutedtext}{April 2023 -- Oct 2025}
\begin{itemize}
...
\textbf{\href{https://github.com/4-sai/homelab}{homelab}} —  Kubernetes cluster with Ansible. Runs full observability stack and self-hosted services.\\[3pt]
